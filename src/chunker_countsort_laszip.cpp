...
namespace chunker_countsort_laszip {
	...
	vector<function<void(int64_t)>> createAttributeHandlers(laszip_header* header, uint8_t* data, laszip_point* point, Attributes& outputAttributes) {
		...
		{ // STANDARD LAS ATTRIBUTES
			...
			// cout<<"offsetRGB: "<< offsetRGB <<endl;
			// cout<<"offsetIntensity: "<< offsetIntensity <<endl;
			// cout<<"offsetReturnNumber: "<< offsetReturnNumber <<endl;
			// cout<<"offsetNumberOfReturns: "<< offsetNumberOfReturns <<endl;
			// cout<<"offsetScanAngleRank: "<< offsetScanAngleRank <<endl;
			// cout<<"offsetScanAngle: "<< offsetScanAngle <<endl;
			// cout<<"offsetUserData: "<< offsetUserData <<endl;
			// cout<<"offsetClassification: "<< offsetClassification <<endl;
			// cout<<"offsetSourceId: "<< offsetSourceId <<endl;
			// cout<<"offsetGpsTime: "<< offsetGpsTime <<endl;
			// cout<<"offsetClassificationFlags: "<< offsetClassificationFlags <<endl;
			// cout<<"offsetOpacity: "<< outputAttributes.getOffset("opacity") <<endl;

			// int offsetOpacity = outputAttributes.getOffset("opacity");
			// Attribute* attributeOpacity = outputAttributes.get("opacity");
			// auto opacity = [data, point, header, offsetOpacity, attributeOpacity](int64_t offset) {
			// 	memcpy(data + offset + offsetOpacity, &point->opacity, 4);

			// 	attributeOpacity->min.x = std::min(attributeOpacity->min.x, double(point->opacity));
			// 	attributeOpacity->max.x = std::max(attributeOpacity->max.x, double(point->opacity));
			// };
